...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { desc: @painting.desc, medium: @painting.medium, name: @painting.name, price: @painting.price, sold: @painting.sold, url: @painting.url }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { desc: @painting.desc, medium: @painting.medium, name: @painting.name, price: @painting.price, sold: @painting.sold, url: @painting.url }
    assert_redirected_to painting_path(assigns(:painting))
  end
